 ...
 * @author Melnikov
 */
public class TemperatureCnverter {
    
    private final Scanner scanner;

    public TemperatureCnverter() {
        this.scanner = new Scanner(System.in);
    }
    
    public TemperatureCnverter(Scanner scanner) {
        this.scanner = scanner;
    }
    /**
     * Method for change type converter;
     * @param none;
    ...
    public void doConvert(){
        ...
        do{
            ...
            System.out.println("1. Целсий -> Фаренгейт");
            System.out.println("2. Фаренгейт -> Целсий");
    ...
    private void convertCelsiusFahrengeit() {
        System.out.print("Введите температуру в Цесльсиях: ");
